...
namespace Player
{
    ...
    private void UpdateHeartsUI()
    {
        ...
        {
            // Solo muestra los corazones que estén por debajo de la vida actual
    ...
    private void Die()
    {
        ...
        // 2. Frenamos la bola para que no caiga rodando inerte por inercia
        Rigidbody rb = GetComponent<Rigidbody>();
        if (rb != null) rb.linearVelocity = Vector3.zero;

        // SC_GameManager.Instance.GameOver();
        Debug.Log("¡Bola destruida! Mostrar pantalla de derrota.");
    }
    }
}